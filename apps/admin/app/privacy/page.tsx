      ...
      <div className="rounded-[var(--radius-2xl)] border border-[var(--border)] bg-[var(--surface)] p-7 shadow-[var(--shadow-lift)]">
        ...
        <section className="mt-8 space-y-4 text-sm leading-7 text-[var(--foreground)]">
          ...
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              Apple 및 Google: 현재 인앱 구독·추천권 판매에는 사용하지 않습니다.
              추후 판매를 활성화할 경우 구매 복원, 영수증·구매 토큰 검증,
              갱신·취소·환불 상태 처리를 위해 필요한 정보를 처리할 수 있으며
              활성화 전에 방침과 스토어 개인정보 선언을 갱신합니다.
            </li>
            <li>
          ...
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              추천 사용 원장·광고 보상 세션: 서비스 제공과 중복 지급 방지를 위해
              계정 유지 기간 동안 보관하며 계정 정리 시 함께 삭제합니다. 광고
              거래 식별자는 운영 로그에 남기지 않습니다. 추후 구독 판매를
              활성화하면 검증된 구독 권한도 같은 기준으로 처리합니다.
            </li>
            <li>
          ...
          <p>
            현재 앱은 자동 갱신 구독을 판매하지 않습니다. 추후 구독 판매가
            활성화된 뒤에는 계정 삭제와 스토어 구독 해지가 별개일 수 있으므로
            해당 시점의 앱 안내와 스토어 구독 관리 절차를 따릅니다.
          </p>
          <p>
            자세한 삭제 절차는{" "}
