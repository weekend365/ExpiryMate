...
const AFFILIATE_PLACEMENT_ENABLED_KEYS = [
  "AFFILIATE_PLACEMENT_RECIPE_MISSING_ENABLED",
  "AFFILIATE_PLACEMENT_SHOPPING_RECENT_ENABLED",
  "AFFILIATE_PLACEMENT_SHOPPING_SEARCH_ENABLED",
  "AFFILIATE_PLACEMENT_INVENTORY_CONSUMED_ENABLED",
  "AFFILIATE_PLACEMENT_COOKING_COMPLETE_ENABLED",
  "AFFILIATE_PLACEMENT_RECIPE_OPTIONAL_ENTRY_ENABLED",
  "AFFILIATE_PLACEMENT_HOME_REORDER_ENABLED",
] as const;

const AFFILIATE_PLACEMENT_ROLLOUT_KEYS = [
  "AFFILIATE_PLACEMENT_RECIPE_MISSING_ROLLOUT_PERCENT",
  "AFFILIATE_PLACEMENT_SHOPPING_RECENT_ROLLOUT_PERCENT",
  "AFFILIATE_PLACEMENT_SHOPPING_SEARCH_ROLLOUT_PERCENT",
  "AFFILIATE_PLACEMENT_INVENTORY_CONSUMED_ROLLOUT_PERCENT",
  "AFFILIATE_PLACEMENT_COOKING_COMPLETE_ROLLOUT_PERCENT",
  "AFFILIATE_PLACEMENT_RECIPE_OPTIONAL_ENTRY_ROLLOUT_PERCENT",
  "AFFILIATE_PLACEMENT_HOME_REORDER_ROLLOUT_PERCENT",
] as const;
...
function validateMonetization(env: EnvMap, errors: string[]) {
  ...
  for (const key of AFFILIATE_PLACEMENT_ENABLED_KEYS) {
    validateBooleanFlag(env, key, errors);
  }
  ...
  for (const key of [
    ...
    ...AFFILIATE_PLACEMENT_ROLLOUT_KEYS,
  ...
  for (const key of AFFILIATE_PLACEMENT_ROLLOUT_KEYS) {
    const value = Number(env[key] ?? 100);
