...
let fixedGeometry = geometry.count == expectedFrames - 120 && geometry.allSatisfy { $0 == geometry.first! }
...
let report: [String:Any] = [
    ...
    "original_frame_geometry_constant": fixedGeometry, "body_frames_geometry_checked": geometry.count,
